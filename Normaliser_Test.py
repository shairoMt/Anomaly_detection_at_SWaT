...
def test_readAndFilterBatchFromCsv():
    n = Normaliser.Normaliser('C:\\Users\\kaspe\\Desktop\\Anomaly_detection_at_SWaT\\chunk.csv', 10)
...
def test_equality_findNormaliserOfBatch():
    n = Normaliser.Normaliser('C:\\Users\\kaspe\\Desktop\\Anomaly_detection_at_SWaT\\chunk.csv', 3)
...
def test_findNormaliser():
    n = Normaliser.Normaliser('C:\\Users\\kaspe\\Desktop\\Anomaly_detection_at_SWaT\\chunk.csv', 1000)
    min_val = n.min_val
    max_val = n.max_val
    mean_val = n.mean_val
...
def test_normaliseBatch():
    ...
    np.testing.assert_array_equal(normalised_batch[0],[-0.3705133275464534, -0.22634999748483334, -0.19019019019019023,
  -0.12512512512512508, 0.9989989989989989])
